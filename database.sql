...
CREATE TABLE Utilisateur (
                             ...
                             CONSTRAINT chk_type_compte CHECK (TypeCompte IN ('candidat', 'recruteur', 'administrateur', 'recruteur en attente', 'administrateur en attente')),

                             FOREIGN KEY (IdOrganisation) REFERENCES Organisation(NumeroSiren)
...
CREATE TABLE OffreEmploi (
                             ...
                             FOREIGN KEY (IdFiche) REFERENCES FichePoste(IdFiche),

                             FOREIGN KEY (IdRecruteur) REFERENCES Utilisateur(Email)
...
CREATE TABLE Candidature (
                             ...
                             FOREIGN KEY (IdCandidat) REFERENCES Utilisateur(Email),

                             FOREIGN KEY (IdOffre) REFERENCES OffreEmploi(IdOffre)
...
CREATE TABLE AssociationFichiers (
                                     ...
                                     FOREIGN KEY (IdCandidat, IdOffre) REFERENCES Candidature(IdCandidat, IdOffre)
...
INSERT INTO AssociationFichiers (IdCandidat, IdOffre, Fichier) VALUES

                                                                   ('john.smith@example.com', 1, 'http://exemple.com/cv/johnsmith.pdf'),
